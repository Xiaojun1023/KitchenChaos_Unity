...
public class OptionsUI : MonoBehaviour
{
    ...
    public void Show(Action OnCloseButtonAction)
    {
        ...
        // GamePauseUI.Instance.Hide(); // Hide the pause UI when showing options
        soundEffectsButton.Select(); // Automatically select the sound effects button when the UI is shown
    }

    private void Hide()
    {
        gameObject.SetActive(false);
        //GamePauseUI.Instance.Show(); // Show the pause UI when hiding options
    }
